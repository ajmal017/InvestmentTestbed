...
SELECT a.event_nm, a.event_cd, a.index_cd
     , (a.pos_cnt+b.neg_cnt)/(a.pos_cnt+b.neg_cnt+c.w_cnt+d.w_cnt) AS pos_hit
	  , c.w_cnt/(a.pos_cnt+b.neg_cnt+c.w_cnt+d.w_cnt) AS neg1_hit
	  , d.w_cnt/(a.pos_cnt+b.neg_cnt+c.w_cnt+d.w_cnt) AS neg2_hit
	  , (a.pos_ratio*a.pos_cnt - b.neg_ratio*b.neg_cnt)/(a.pos_cnt+b.neg_cnt+c.w_cnt+d.w_cnt) AS pos_ratio
	  , c.w_ratio*c.w_cnt/(a.pos_cnt+b.neg_cnt+c.w_cnt+d.w_cnt) AS neg1_ratio
	  , d.w_ratio*d.w_cnt/(a.pos_cnt+b.neg_cnt+c.w_cnt+d.w_cnt) AS neg1_ratio
  FROM
