...
def CrawlingData(options, do_profile, do_financial, do_earnings, do_dividends, do_price_list, loop_sleep_term):
        ...
        if do_price_list[0] == True:
            ...
            for idx_comp, comp_info in comp_info_list.iterrows():
                ...
                if do_price_list[1] == True:
                    ...
                    prices = obj.GetPriceData(comp_info['price_url'], set_calendar=do_price_list[2], start_date=start_date, end_date=end_date, t_gap=1.5)
...
if __name__ == '__main__':
    ...
    CrawlingData(options, do_profile=True, do_financial=False, do_earnings=False, do_dividends=False, do_price_list=[False, False, False], loop_sleep_term=0)
